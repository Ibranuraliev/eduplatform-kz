    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('hr', 'HR'), ('finance', 'Finance Manager'), ('admin', 'Admin')], default='student', max_length=20)),
                ('phone', models.CharField(max_length=20, unique=True)),
                ('city', models.CharField(blank=True, max_length=100)),
                ('telegram_user_id', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('telegram_phone', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='phone_changes_made', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phone_changes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
